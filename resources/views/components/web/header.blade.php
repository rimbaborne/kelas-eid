...
<header>
    ...
    <div class="transition-all duration-500 sticky-header z-medium dark:bg-whiteColor-dark">
        <nav class="lg:container 3xl:container2-lg 4xl:container mx-auto relative">
            <div class="py-15px lg:py-3 px-15px mx-4">
                <div class="grid grid-cols-2 lg:grid-cols-12 items-center gap-15px -mx-15px">
                    <!-- navbar left -->
                    <div class="lg:col-start-1 lg:col-span-2">
                        <a href="index.html" class="block"><img src="./assets/images/logo/logo_1.png"
                                alt="Logo" class="w-logo-sm lg:w-auto py-2"></a>
                    </div>
                    <!-- Main menu -->
                            ...
                            <li class="nav-item group">
                                ...
                                <div class="dropdown absolute left-0 translate-y-10 z-medium hidden opacity-0"
                                    ...
                                    <div
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="./pages/zoom/zoom-meetings.html"
                                                            class="text-sm 2xl:text-base font-semibold text-contentColor border-l-2 border-transparent transition duration-300 hover:border-primaryColor p-10px block hover:bg-whitegrey1 hover:text-primaryColor leading-sm lg:leading-lg 2xl:leading-lg dark:text-whiteColor dark:hover:bg-whitegrey1-dark dark:hover:text-primaryColor">Zoom
                                                            <span
                                                                class="text-size-12 font-semibold text-primaryColor bg-whitegrey3 px-15px py-5px ml-5px rounded">Online
                                                                Call</span></a>
                                                    </li>
                                                    <li>
                                        ...
                                        <!-- dropdown banner -->
                                        <div class="pt-30px">
                                            <img src="./assets/images/mega/mega_menu_2.png" alt="Mega Menu"
                                ...
                                <div class="dropdown absolute left-0 translate-y-10 z-medium hidden opacity-0"
                                    ...
                                    <div
                                        ...
                                        <div class="grid grid-cols-4 gap-x-30px">
                                            ...
                                            <!-- dropdown banner -->
                                            <div>
                                                <img src="./assets/images/mega/mega_menu_1.png" alt="Mega Menu"
                                                    class="w-full rounded-standard">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <ul>
                                            <li class="relative group/nested">
                                                ...
                                                <!-- dropdown menu -->
                                                <div class="nested-dropdown absolute left-full top-0 z-50 hidden opacity-0 group-hover/nested:block group-hover/nested:opacity-100"
                                                    style="transition: 0.3s">
                                                    <div
                                                        class="shadow-dropdown max-w-dropdown2 w-2000 py-14px rounded-standard bg-white dark:bg-whiteColor-dark">
                                                        <ul>
                                                ...
                                                <div class="nested-dropdown absolute left-full top-0 z-50 hidden opacity-0 group-hover/nested:block group-hover/nested:opacity-100"
                                                    ...
                                                    <div
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="./pages/dashboards/instructor-dashboard.html"
                                                                    class="text-sm 2xl:text-base font-semibold text-contentColor border-l-2 border-transparent transition duration-300 hover:border-primaryColor px-25px py-10px hover:bg-whitegrey1 block hover:text-primaryColor leading-sm lg:leading-lg 2xl:leading-lg dark:text-contentColor-dark dark:hover:text-primaryColor dark:hover:bg-whitegrey1-dark">Ins.
                                                                    Dashboard
                                                                </a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="./pages/dashboards/instructor-my-quiz-attempts.html"
                                                                    class="text-sm 2xl:text-base font-semibold text-contentColor border-l-2 border-transparent transition duration-300 hover:border-primaryColor px-25px py-10px hover:bg-whitegrey1 block hover:text-primaryColor leading-sm lg:leading-lg 2xl:leading-lg dark:text-contentColor-dark dark:hover:text-primaryColor dark:hover:bg-whitegrey1-dark">My
                                                                    Quiz</a>
                                                            </li>
                                                            <li>
                                                                <a href="./pages/dashboards/instructor-order-history.html"
                                                                    class="text-sm 2xl:text-base font-semibold text-contentColor border-l-2 border-transparent transition duration-300 hover:border-primaryColor px-25px py-10px hover:bg-whitegrey1 block hover:text-primaryColor leading-sm lg:leading-lg 2xl:leading-lg dark:text-contentColor-dark dark:hover:text-primaryColor dark:hover:bg-whitegrey1-dark">Order
                                                                    History</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="./pages/dashboards/instructor-quiz-attempts.html"
                                                                    class="text-sm 2xl:text-base font-semibold text-contentColor border-l-2 border-transparent transition duration-300 hover:border-primaryColor px-25px py-10px hover:bg-whitegrey1 block hover:text-primaryColor leading-sm lg:leading-lg 2xl:leading-lg dark:text-contentColor-dark dark:hover:text-primaryColor dark:hover:bg-whitegrey1-dark">Quiz
                                                                    Attempts</a>
                                                            </li>
                                                            <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="./pages/dashboards/student-enrolled-courses.html"
                                                                    class="text-sm 2xl:text-base font-semibold text-contentColor border-l-2 border-transparent transition duration-300 hover:border-primaryColor px-25px py-10px hover:bg-whitegrey1 block hover:text-primaryColor leading-sm lg:leading-lg 2xl:leading-lg dark:text-contentColor-dark dark:hover:text-primaryColor dark:hover:bg-whitegrey1-dark">Enrolled
                                                                    Courses
                                                                </a>
                                                            </li>
                                                            <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="./pages/ecommerce/shop.html"
                                                    ...
                                                    <span
                                                        class="text-size-12 font-semibold text-primaryColor bg-whitegrey3 px-15px py-5px rounded">Online
                                                        Store</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="./pages/ecommerce/product-details.html"
                                                    class="text-sm 2xl:text-base font-semibold text-contentColor border-l-2 border-transparent transition duration-300 hover:border-primaryColor px-25px py-10px hover:bg-whitegrey1 block hover:text-primaryColor leading-sm lg:leading-lg 2xl:leading-lg dark:text-contentColor-dark dark:hover:text-primaryColor dark:hover:bg-whitegrey1-dark">Product
                                                    Details
                                                </a>
                                            </li>
                                            <li>
                    ...
                    <div class="lg:col-start-10 lg:col-span-3">
                        <ul class="relative nav-list flex justify-end items-center">
                            <li class="px-5 lg:px-10px 2xl:px-5 group block lg:hidden">
                                ...
                                <!-- dropdown menu -->
                                <div class="dropdown absolute right-0 lg:right-8 translate-y-10 z-medium hidden opacity-0 pt-5px"
                                    style="transition: 0.3s">
                                    <div
                                        ...
                                        <ul
                                            ...
                                            <li class="relative flex gap-x-15px items-center">
                                                <a href="#"><img src="./assets/images/grid/cart1.jpg"
                                            ...
                                            <li class="relative flex gap-x-15px items-center">
                                                <a href="#"><img src="./assets/images/grid/cart2.jpg"
                                                        alt="photo" class="w-card-img py-[3px]"></a>
                                                <div>
                                                    <a href="#"
                                            ...
                                            <li class="relative flex gap-x-15px items-center">
                                                <a href="#"><img src="./assets/images/grid/cart3.jpg"
                                                        alt="photo" class="w-card-img py-[3px]"></a>
                                                <div>
                                                    <a href="#"
                                ...
                                <ul class="accordion-container">
                                    ...
                                    <li>
                                        <a href="#" class="pl-15px pt-3 pb-7px"><img class="w-full"
                                                src="./assets/images/mega/mega_menu_2.png" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-content h-0 overflow-hidden transition-all duration-500">
                            <div class="content-wrapper">
                                <ul class="accordion-container">
                                    ...
                                    <li>
                                        <a href="#" class="pl-15px pt-3 pb-7px"><img class="w-full"
                                                src="./assets/images/mega/mega_menu_1.png" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
