<li class="p-4 bg-white rounded-lg">
    ...
    <ul id="dropdown-playground-1" class="space-y-2 py-2">
        ...
        <li>
            <a href="{{ url('/') }}/kelas/kelas-profit-10-juta/3" class="text-base ml-4 text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-400 transition duration-75 dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->is('kelas/kelas-profit-10-juta/3') ? 'bg-slate-200' : '' }}">
                <x-carbon-triangle-right-solid class="w-2 h-2 mx-4" />
                Slide Presentasi
            </a>
        </li>
