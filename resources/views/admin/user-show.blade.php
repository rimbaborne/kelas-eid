    ...
    <div class="flow-root pb-6">
        ...
        <section class="text-gray-900 body-font">
            <div class="mx-auto container ">
                <x-splade-form method="PUT" class="space-y-2 grid grid-cols-1 sm:grid-cols-2 gap-4" action="{{ route('admin.user.update',['id' =>  $user->id ]) }}"
                    :default="[
                                'name' => $user->name,
                                'email' => $user->email,
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <x-splade-select name="phone_code" :label="__('Nomor HP Whatsapp')" class="py-0 w-60 text-sm block" choices
                                required>
                        ...
                        <x-splade-input type="text" name="password" min="6"
                    ...
                    <div class="">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 border border-slate-300 rounded-lg p-4">
                    ...
                    <div class="py-2 text-right">
                        <x-splade-submit class="bg-primary-700 text-white" :label="__('Update')" />
                    </div>
                </x-splade-form>
            </div>
        </section>
