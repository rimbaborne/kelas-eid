    ...
    <div class="flow-root pb-6">
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-5 ">
                <h1 class="text-lg font-semibold py-4">Peserta {{ str_replace('-', ' ', $kelas) }}</h1>
                <div class=" border-gray-400 border-b mb-4"></div>
                <x-splade-form method="put" class="space-y-2" :default="$peserta" action="{{ route('agen.plus.peserta.update',[ 'kelas' =>  'kelas-profit-10-juta' , 'id' =>  $id ]) }}">
                    ...
                    <x-splade-input type="text" name="show_password" min="6"
