...
@section('content')
    ...
    <x-auth-card>
        <h1 class="text-2xl font-bold text-center py-4">Member Area</h1>
        <x-splade-form action="/pemesanan/kelas-profit-10-juta/plus/store/{{ request()->ref ?? 100188 }}" class="space-y-4"
            ...
            <div class="flex items-center justify-center">
                <x-splade-submit class="bg-primary-700 text-white" :label="__('Daftar')" />
            </div>
