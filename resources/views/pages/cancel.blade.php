...
@section('content')
    ...
    <x-auth-card>
        <h1 class="text-2xl font-bold text-center py-4">Pemesanan Dibatalkan</h1>
            ...
            @if(Auth::check())
                <label class="block">
                    ...
                    <div class="flex rounded-md border border-gray-300 shadow-sm">
                        <input class="block w-full border-0  bg-gray-100 disabled:cursor-not-allowed rounded-md" name="name" type="text"  readonly="" value="{{ Auth::user()->name }}">
                    </div>
                </label>
                <label class="block">
                    <span class="block mb-1 text-gray-700 font-sans"> Email </span>
                    <div class="flex rounded-md border border-gray-300 shadow-sm">
                        <input class="block w-full border-0  bg-gray-100 disabled:cursor-not-allowed rounded-md" name="email" type="text"  readonly="" value="{{ Auth::user()->email }}">
                    </div>
                </label>
                <label class="block">
                    <span class="block mb-1 text-gray-700 font-sans"> Nomor Whatsapp </span>
                    <div class="grid grid-cols-3 gap-4">
                        <div class="col-span-1 rounded-md border border-gray-300 shadow-sm">
                            <input class="block w-full border-0 bg-gray-100 disabled:cursor-not-allowed rounded-md" name="phone_code" type="text" readonly="" value="{{ Auth::user()->phone_code }}">
                        </div>
                        <div class="col-span-2 rounded-md border border-gray-300 shadow-sm">
                            <input class="block w-full border-0 bg-gray-100 disabled:cursor-not-allowed rounded-md" name="phone_number" type="text" readonly="" value="{{ Auth::user()->phone_number }}">
                        </div>
                    </div>
                </label>
            @else
            ...
            <div class="container mx-auto py-8">
                <div class="max-w-lg mx-auto bg-white rounded-lg ">
                    ...
                    {{-- <div class="mb-4">
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center p-4  border rounded-lg cursor-pointer hover:bg-gray-50">
                                <x-splade-radio name="payment_method" value="linkaja" class="mr-2" data-fee="{{ 123000 * 0.007 }}" data-inis="LinkAja" data-type="e_wallet"/>
                                <img src="{{ url('/') }}/assets/pembayaran/linkaja.svg" alt="LinkAja"
                                    class="h-6 mr-2">
                                LinkAja
                            </label>
                            <label class="flex items-center p-4  border rounded-lg cursor-pointer hover:bg-gray-50">
                                <x-splade-radio name="payment_method" value="dana" class="mr-2" data-fee="{{ 123000 * 0.007 }}" data-inis="Dana" data-type="e_wallet"/>
